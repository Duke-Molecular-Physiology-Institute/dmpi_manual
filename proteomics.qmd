...
normalized_proteins = filtered_proteins %>%
                      dplyr::mutate_at(dplyr::vars(dplyr::starts_with("abundance_")), function(x){avg_protein_abundance / sum(x)})
...
normalized_peptides = filtered_peptides %>%
                      dplyr::mutate_at(dplyr::vars(dplyr::starts_with("abundance_")), function(x){avg_peptide_abundance / sum(x)})
```
